...
//誕生日メール：更新画面
Route::post('/messagesedit/{message}',[MessageController::class,"edit"])->name('message_edit'); //通常
Route::get('/messagesedit/{message}', [MessageController::class,"edit"])->name('edit');      //Validationエラーありの場合
