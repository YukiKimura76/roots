                    ...
                    <div class="container px-5 py-10 mx-auto flex flex-wrap items-center">
                      ...
                      <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                        <div class="relative mb-4">
                          <label for="full-name" class="leading-7 text-sm text-gray-600">誰からもらいたい</label>
                        ...
                        <div class="relative mb-4  py-5">
                          <label for="email" class="leading-7 text-sm text-gray-600">いつまで</label>
                        ...
                        dic
                        <button class="text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg font-bold">登録する</button>
                        <button class="text-white bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg font-bold py-7">登録済み配信一覧</button>
                      </div>
                    </div>
                  </section>
                  <div class="flex flex-row-reverse">
                      <button class="text-white bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg font-bold">登録済み配信一覧</button>
                  </div>
              </div>
          </div>
      </div>
