...
//誕生日メール：更新画面
Route::post('/messageedit/{message}',[MessageController::class,"edit"])->name('message_edit'); //通常
Route::get('/messageedit/{message}', [MessageController::class,"edit"])->name('edit');      //Validationエラーありの場合

//本：更新画面
Route::post('/message/update',[MessageController::class,"update"])->name('book_update');
