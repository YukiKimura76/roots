                        ...
                        <div class="relative flex items-center justify-between md:justify-end h-16">
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center">
                                <x-dropdown align="right" width="48">
                                    <x-slot name="trigger">
                                        <button class="flex items-center text-sm leading-4 font-medium rounded-md text-blue-100 dark:text-gray-400 bg-white dark:bg-gray-800 hover:bg-blue-700  focus:outline-none transition ease-in-out duration-200">
