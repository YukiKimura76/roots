...
//誕生日メール：更新画面
Route::post('/messageedit/{book}',[MessageController::class,"edit"])->name('book_edit'); //通常
Route::get('/booksedit/{book}', [MessageController::class,"edit"])->name('edit');      //Validationエラーありの場合
